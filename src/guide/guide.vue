<template>
    <div class="guide" :style="{ width: width + 'px', height: height + 'px' }">
        ...
        <div class="p_container">
            ...
            <p></p>
            <p class="p_2"><span class="bang"></span>、<span class="victory"></span>、<span class="gun"></span>、<span class="hi"></span>、<span class="ok"></span>，将是我们今</p>
            <p class="p_2">后沟通的暗号。我很想穿过摄像头，知道今天</p>
            <p class="p_2">的你工作还顺利么？知道你很努力，但久坐不</p>
            <p class="p_2">动不太好哦！我正在散步，但好像误入了一个</p>
            <p class="p_2">迷宫，你休息一下，陪我走出去吧？</p>
        </div>
        <div class="p_promise">
            <p>小胖承诺：您的数据将始终被安全地保存在本地，不会存在任何数据泄露的风险，请放心开启摄像头。如果您仍需关闭摄像头，</p>
            <p>可点击菜单中的摄像头按钮，待按钮置灰即已关闭次功能，360持续为您的数据安全保驾护航。</p>
        </div>
